...
if __name__ == "__main__":
    ...
    print("Сортировка по возрастанию номера студента:\n")
    ...
    print("Выборка студентов, находящихся в группе ИВТАСбд:\n")

    for item in d.select_rows_with_likes_count_more_than("ИВТАСбд"):
        print(item)
